    ...
    <div class="container">
        ...
        <div class="card mt-4">
            <div class="card-header text-center mt-4">
                <h5><b>Dokumen Penerimaan</b></h5>
            </div>
            <form action="{{ route('superadmin.form.vehicle.received.store') }}" method="POST" class="mt-2">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="phone_number" type="text" class="bg-light form-control @error('phone_number') is-invalid @enderror" value="{{old('phone_number')}}" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="address" class="bg-light form-control @error('address') is-invalid @enderror" required id="" cols="30" rows="10">{{old('address')}}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="bg-light form-control @error('type') is-invalid @enderror" value="{{old('type')}}" required>
                                    <option value="2_wheels" {{ old('type') == '2_wheels' ? 'selected' : '' }}>Roda 2</option>
                                    <option value="4_wheels" {{ old('type') == '4_wheels' ? 'selected' : '' }}>Roda 4</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="merk" type="text" class="bg-light form-control @error('merk') is-invalid @enderror" value="{{old('merk')}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="model" type="text" class="bg-light form-control @error('model') is-invalid @enderror" value="{{old('model')}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="license_plate" type="text" class="bg-light form-control @error('license_plate') is-invalid @enderror" value="{{old('license_plate')}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="year" type="text" class="bg-light form-control @error('vehicle_year') is-invalid @enderror" value="{{old('vehicle_year')}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="km" type="number" class="bg-light form-control @error('km') is-invalid @enderror" value="{{old('km')}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="received_date" type="date" class="bg-light form-control @error('received_date') is-invalid @enderror" value="{{old('received_date')}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="receiver" id="" class="bg-light form-control @error('receiver') is-invalid @enderror" value="{{old('receiver')}}" required>
                                    @foreach ($crews as $crew)
                                        <option value="{{ $crew->id }}" {{ old('receiver', $crew->id) == $crew->id ? 'selected' : '' }}>{{ $crew->name }}</option>
                                    @endforeach
                                </select>
