        ...
        <div>
            ...
            <div class="row">
                <div class=" col-md-6 col-sm-6">
                    <div class="card card-stats text-white bg-dark">
                        <div class="card-body">
                            <div class="row">
                    ...
                    <div class="card card-stats text-white bg-dark">
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        <p class="card-category">Total Omzet</p>
                                        <p class="card-title">RP.9.000.000
                                            <p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class=" col-md-6 col-sm-6">
                    <div class="card card-stats text-white bg-dark">
                        ...
                        <div class="card-footer ">
                            ...
                            <div class="stats">
                                <i class="fa fa-calendar-o"></i> Last Year
                            </div>
                        </div>
                    </div>
                </div>
